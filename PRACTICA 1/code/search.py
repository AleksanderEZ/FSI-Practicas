...
def best_value_first_graph_search(problem):
    """Search the cheapest path first"""
    return graph_search(problem, BFSQueue())

# ______________________________________________________________________________
## Informed Search algorithms
def best_value_first_heuristics_graph_search(problem):
    """Search the cheapest path first"""
    return graph_search(problem, BFSHQueue(problem))
